...
@RestController
@RequestMapping("/api/v1/results") // Oyun sonuçları için yeni bir ana yol
public class GameResultController {
    ...
    /**
     * Yeni bir oyun sonucunu kaydeder.
     * Bu endpoint'i mobil uygulama, oyun bittiğinde çağırır.
     * POST /api/v1/results/child/{childId}
     *
    ...
    public ResponseEntity<?> saveGameResult(
            ...
            @Valid @RequestBody CreateGameResultRequest request,
        ...
        try {
            GameResult savedResult = gameResultService.saveGameResult(childId, request);
    ...
    public ResponseEntity<?> getGameResultsForChild(
            @PathVariable Long childId,
        ...
        try {
            List<GameResult> results = gameResultService.getGameResultsForChild(childId);
